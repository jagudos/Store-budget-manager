...
function authenticate(username, password, logger) {
	...
	db.users.findOne({ username: username }, function (err, user) {
		...
		if (user && bcrypt.compareSync(password, user.hash)) {
			...
			var log = new Object();
			log.date = new Date();
			log.action = 'INICIO_SESION_EXITO';
			log.desc = 'el usuario ' + user.username + ' se ha logado correctamente', user.username;
